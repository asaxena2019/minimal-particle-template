...
Template for my personal website. This includes more sections that you can customize, the famous animated particle background, and changes to the original stylesheet.

## How I Created My Website

I forked this [repo](https://github.com/github/personal-website) and made some changes, which can be found in this repo. For an example, visit [this website](http://anushkasaxena2000.github.io/).
